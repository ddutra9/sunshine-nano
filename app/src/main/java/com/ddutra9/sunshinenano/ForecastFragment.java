        ...
        if (null != appbarView) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                recycleViewForecast.addOnScrollListener(new RecyclerView.OnScrollListener() {
                    ...
                    @Override
                    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                        if (0 == recycleViewForecast.computeVerticalScrollOffset()) {
            ...
            recycleViewForecast.getViewTreeObserver().addOnPreDrawListener(new ViewTreeObserver.OnPreDrawListener() {
                ...
                public boolean onPreDraw() {
                    ...
                    if (recycleViewForecast.getChildCount() > 0) {
                        ...
                        // to, do so now.
                        recycleViewForecast.smoothScrollToPosition(position);
                        RecyclerView.ViewHolder vh = recycleViewForecast.findViewHolderForAdapterPosition(position);
