package com.ddutra9.sunshinenano.sync;
...
// 60 seconds (1 minute)  180 = 3 hours
    ...
    private static final int WEATHER_NOTIFICATION_ID = 3004;//Se usar o ID de notificação, seu aplicativo postará, no máximo, uma notificação.
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        if (locationCursor.moveToFirst()) {
            ...
            Uri uri = getContext().getContentResolver().insert(WeatherContract.LocationEntry.CONTENT_URI,
                    contentValues);
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        try {
            ...
            Uri builtUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                    ...
                    .appendQueryParameter(APPID_PARAM, getContext().getString(R.string.OPEN_WEATHER_MAP_API_KEY))
                    .build();
